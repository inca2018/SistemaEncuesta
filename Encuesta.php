...
<body>
    ...
    if(isset($_GET['env']) && isset($_GET['cli']) && isset($_GET['enc'])){
        ...
        <div class="col-6 col-12-small">
            <h3>LA ENCUESTA YA SE REALIZO!</h3>
        </div>
    </div>';
    ...
    <div id="ModuloRespuesta" class="row m-5 center_element" style="display:none;">
         <div class="col-6 col-12-small">
            <h3>GRACIAS POR SUS RESPUESTAS, SE ENVIO LOS RESULTADOS A NUESTRO SISTEMA.</h3>
        </div>
    </div>
    ...
    <div class="row m-5 center_element ">
        <div cl  ass="col-6 col-12-small">
            <h3>SE ENCONTRO UN ERROR EN LA BUSQUEDA DE LA ENCUESTA</h3>
        </div>
